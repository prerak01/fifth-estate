...
export const createBallotPrivateState = (secretKey) => ({
    secretKey,
});
/* **********************************************************************
 ...
 *  is the private state type, like BallotPrivateState defined above.
 *
 ...
 * the declared return value.  In this case, that's a BallotPrivateState
