// This file is part of SilentProof/example-ballot.
// Copyright (C) 2025 SilentProof
...
import {
  ...
  type Ledger,
  ledger,
} from "../managed/ballot/contract/index.cjs";
import { type BallotPrivateState, witnesses } from "../witnesses.js";

/**
 * Serves as a testbed to exercise the contract in tests
 */
export class BallotSimulator {
  readonly contract: Contract<BallotPrivateState>;
  circuitContext: CircuitContext<BallotPrivateState>;

  constructor(secretKey: Uint8Array) {
    this.contract = new Contract<BallotPrivateState>(witnesses);
    const {
      currentPrivateState,
  ...
  public getPrivateState(): BallotPrivateState {
